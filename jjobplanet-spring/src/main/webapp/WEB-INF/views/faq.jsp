                        ...
                        <div class="policy_body_wrap">
                            <div>
                                ...
                                <div class="faq_question_row">
                                    <span class="faq_question"><a href="javascript:ShowAnswer(1);">Q : 잡플래닛은 어떻게 사용자를 보호하나요?</a></span>
                                </div>
                                <div id="faq_answer1" class="faq_answer_row">
                                    <span>
                                        A : 잡플래닛은 사용자 정보를 최소한으로 수집합니다. 정보를 수집하지 않기 때문에 유출될 정보도 없습니다.
                                ...
                                <div class="faq_question_row">
                                    <span class="faq_question"><a href="javascript:ShowAnswer(2);">Q : 잡플래닛의 정보는 어떻게 이용할 수 있나요?</a></span>
                                </div>
                                <div id="faq_answer2" class="faq_answer_row">
                                    <span>
                                        A : 잡플래닛에서는 누구나 전·현직 직원이 남긴 평점과 기업리뷰, 연봉정보, 면접후기 등을 찾아볼 수 있습니다.
